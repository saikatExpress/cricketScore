                ...
                <div class="page-header">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add Umpire</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-validation">
                            ...
                            <form class="form-valide" action="{{ route('cricket.store') }}" method="post"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-username">Umpire Name <span
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-select2">Country <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-8">
                                        <select class="js-select2 form-control" id="val-select2" name="first_team"
                                            ...
                                            <option value="">Arab Emirate</option>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-username">Umpire Image <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-8">
                                        <input type="file" class="form-control" id="val-username" name="umpire_image"
                                            placeholder="Enter a name..">
                                        @error('team-image')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
