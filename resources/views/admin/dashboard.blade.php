...
<head>
    ...
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
    <link rel="shortcut icon" href="{{ asset('images/errors/Untitled.jpeg') }}">
    ...
    <!-- Styles -->
    <link href="{{ asset('adminFrontend/css/lib/calendar2/pignose.calendar.min.css') }}" rel="stylesheet">
    <link href="{{ asset('adminFrontend/css/lib/chartist/chartist.min.css') }}" rel="stylesheet">
    <link href="{{ asset('adminFrontend/css/lib/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('adminFrontend/css/lib/themify-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('adminFrontend/css/lib/owl.carousel.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('adminFrontend/css/lib/owl.theme.default.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('adminFrontend/css/lib/weather-icons.css') }}" rel="stylesheet" />
    <link href="{{ asset('adminFrontend/css/lib/menubar/sidebar.css') }}" rel="stylesheet">
    <link href="{{ asset('adminFrontend/css/lib/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('adminFrontend/css/lib/helper.css') }}" rel="stylesheet">
    <link href="{{ asset('adminFrontend/css/style.css') }}" rel="stylesheet">
</head>
...
<body>
                            ...
                            <div class="card">
                                ...
                                <div class="recent-comment m-t-15">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object"
                                                    src="{{ asset('images/avatar/1.jpg') }}" alt="..."></a>
                                        </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object"
                                                    src="{{ asset('images/avatar/2.jpg') }}" alt="..."></a>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object"
                                                    src="{{ asset('images/avatar/3.jpg') }}" alt="..."></a>
                                        </div>
                                        <div class="media-body">
    ...
    <script src="{{ asset('adminFrontend/js/lib/jquery.nanoscroller.min.js') }}"></script>
    <!-- nano scroller -->
    <script src="{{ asset('adminFrontend/js/lib/menubar/sidebar.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/lib/preloader/pace.min.js') }}"></script>
    <!-- sidebar -->

    <script src="{{ asset('adminFrontend/js/lib/bootstrap.min.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/scripts.js') }}"></script>
    <!-- bootstrap -->

    <script src="{{ asset('adminFrontend/js/lib/calendar-2/moment.latest.min.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/lib/calendar-2/pignose.calendar.min.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/lib/calendar-2/pignose.init.js') }}"></script>


    <script src="{{ asset('adminFrontend/js/lib/weather/jquery.simpleWeather.min.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/lib/weather/weather-init.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/lib/circle-progress/circle-progress.min.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/lib/circle-progress/circle-progress-init.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/lib/chartist/chartist.min.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/lib/sparklinechart/jquery.sparkline.min.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/lib/sparklinechart/sparkline.init.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/lib/owl-carousel/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('adminFrontend/js/lib/owl-carousel/owl.carousel-init.js') }}"></script>
    <!-- scripit init-->
    <script src="{{ asset('adminFrontend/js/dashboard2.js') }}"></script>
</body>
